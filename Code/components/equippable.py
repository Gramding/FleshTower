...
class MarrowVisage(Equippable):
    def __init__(self):
        super().__init__(equipment_type=EquipmentType.HEAD, stat_bonus={"FI":1, "TM":1})
...
class VeinboundSpectacles(Equippable):
    def __init__(self):
        super().__init__(equipment_type=EquipmentType.EYES, stat_bonus={"NS":1, "CD":1})
...
class EyeOfTheWyrm(Equippable):
    def __init__(self):
        super().__init__(equipment_type=EquipmentType.EYES, stat_bonus={"TM":1, "FI":1})
...
class BloodstareMonocle(Equippable):
    def __init__(self):
        super().__init__(equipment_type=EquipmentType.EYES, stat_bonus={"NS":1, "PE":1})
...
class SinewChoker(Equippable):
    def __init__(self):
        super().__init__(equipment_type=EquipmentType.NECKLACE, stat_bonus={"FI":1, "TM":1})
...
class OssifiedTorque(Equippable):
    def __init__(self):
        super().__init__(equipment_type=EquipmentType.NECKLACE, stat_bonus={"CD":1, "FI":1})
...
class RibBoundMedallion(Equippable):
    def __init__(self):
        super().__init__(equipment_type=EquipmentType.NECKLACE, stat_bonus={"TM":1, "PE":1})

class CarotidChain(Equippable):
    def __init__(self):
        super().__init__(equipment_type=EquipmentType.NECKLACE, stat_bonus={"FI":1, "CD":1})
...
class VeinlaceWristband(Equippable):
    def __init__(self):
        super().__init__(equipment_type=EquipmentType.WRIST, stat_bonus={"TM":1, "FI":1})
...
class Bloodring(Equippable):
    def __init__(self):
        super().__init__(equipment_type=EquipmentType.WRIST, stat_bonus={"NS":1, "CD":1})
...
class TumorLacedStrap(Equippable):
    def __init__(self):
        super().__init__(equipment_type=EquipmentType.BELT, stat_bonus={"FI":1, "PE":1})
...
class Marrowstrap(Equippable):
    def __init__(self):
        super().__init__(equipment_type=EquipmentType.BELT, stat_bonus={"TM":1, "NS":1})

class Sinewbelt(Equippable):
    def __init__(self):
        super().__init__(equipment_type=EquipmentType.BELT, stat_bonus={"CD":1, "FI":1})
